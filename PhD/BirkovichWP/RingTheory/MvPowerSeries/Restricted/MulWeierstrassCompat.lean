...
import PhD.BirkovichWP.RingTheory.MvPowerSeries.Restricted.Distinguished
import PhD.BirkovichWP.RingTheory.PowerSeries.Restricted.MulDistinguishedCompat
...
(`PhD.ForMathlib.…MvPowerSeries.Restricted.MulWeierstrass`) restate with the field-facing
`IsDistinguishedX0` hypothesis, recovering the endpoints of the Gauss-extension development
in `PhD.BirkovichWP.…MvPowerSeries.Restricted.DivisibleRadius` with no extension machinery.
-/
