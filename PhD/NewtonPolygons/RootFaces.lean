...
file assembles those counts into the two face endpoints of `PhD/NewtonPolygons/Face.lean`, which
...
exactly as in `PhD/NewtonPolygons/PolynomialRoots.lean`; `card_roots_le_of_isAlgClosed` transports
