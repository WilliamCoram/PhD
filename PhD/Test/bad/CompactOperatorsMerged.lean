...
The three parent blueprints remain as source documentation:
`PhD.Test.CompactOperators` (Buzzard), `PhD.Test.CompactOperatorsBellaiche`
(Bellaïche), `PhD.Test.CompactOperatorsJohanssonNewton` (Johansson–Newton).
-/
