...
compact operators in this project, alongside `PhD.Test.CompactOperators` (Buzzard) and
`PhD.Test.CompactOperatorsBellaiche` (Bellaïche's Eigenbook).  Statements are given in
