...
import PhD.ForMathlib.Topology.Algebra.Bounded
import PhD.ForMathlib.Topology.Algebra.PowerBounded
import PhD.ForMathlib.Topology.Algebra.TopologicallyNilpotent
...
power-bounded API (`PhD/ForMathlib/Topology/Algebra/{Bounded, PowerBounded,
...
* `topologicallyNilpotentElements` and `topNilpAddSubgroup` are supplied below; they are candidates
  for `PhD/ForMathlib/Topology/Algebra/TopologicallyNilpotent.lean`.
