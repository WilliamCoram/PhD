...
(`faceRight_mul`, `faceLeft_mul`, `PhD/NewtonPolygons/Product.lean`), and the classical factor's
faces are counted by its roots (`card_roots_slope`, `PhD/NewtonPolygons/PolynomialRoots.lean`).
