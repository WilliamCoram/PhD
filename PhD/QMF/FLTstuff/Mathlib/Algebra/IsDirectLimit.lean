...
PORT (T016d-2b) of `FLT.Mathlib.Algebra.IsDirectLimit` (194 l., load-bearing for
`DedekindDomain.FiniteAdeleRing.{IsDirectLimitRestricted,TensorRestrictedProduct}`).
-/
