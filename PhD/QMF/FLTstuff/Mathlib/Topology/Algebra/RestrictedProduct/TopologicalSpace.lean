...
import PhD.QMF.FLTstuff.Mathlib.Topology.Bases
...
`PhD.QMF.FLTstuff.Mathlib.Topology.Algebra.RestrictedProduct.Module` are ported
...
(needed by `PhD.QMF.FLTstuff.{Mathlib.RingTheory.DedekindDomain.FiniteAdeleRing,
...
from the same FLT source file (needed by `PhD.QMF.FLTstuff.HaarMeasure.HaarChar.AddEquiv`).
...
-- (needed by `PhD.QMF.FLTstuff.Mathlib.NumberTheory.NumberField.FiniteAdeleRing`).
...
-- (needed by `PhD.QMF.FLTstuff.HaarMeasure.HaarChar.AddEquiv`).
...
-- (needed by `PhD.QMF.FLTstuff.HaarMeasure.HaarChar.FiniteAdeleRing`).
