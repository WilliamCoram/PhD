...
import PhD.QMF.FLTstuff.Mathlib.Topology.Algebra.RestrictedProduct.Algebra
...
load-bearing for `PhD.QMF.FLTstuff.DedekindDomain.FiniteAdeleRing.{TensorProduct,BaseChange}`).
-/
