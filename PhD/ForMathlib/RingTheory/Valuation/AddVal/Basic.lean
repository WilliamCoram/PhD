...
-/
import PhD.ForMathlib.Algebra.Order.GroupWithZero.WithZero
...
The normed-field applications live in `PhD/ForMathlib/Topology/Algebra/Valued/AddVal.lean`, and
the `ℚ_p` verification in `PhD/ForMathlib/NumberTheory/Padics/AddVal.lean`.
