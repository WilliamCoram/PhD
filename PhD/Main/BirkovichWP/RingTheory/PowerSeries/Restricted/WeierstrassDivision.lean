...
import PhD.Main.BirkovichWP.RingTheory.PowerSeries.Restricted.GaussNorm
import PhD.Main.ForMathlib.RingTheory.PowerSeries.Restricted.DivisionSet
import PhD.Main.BirkovichWP.RingTheory.PowerSeries.Restricted.Rescale
import PhD.Main.ForMathlib.RingTheory.PowerSeries.Restricted.Residue
import PhD.Main.ForMathlib.Topology.MetricSpace.HausdorffDistance
...
now lives in `PhD.Main.BirkovichWP.…PowerSeries.Restricted.WeierstrassDivisionOracle`.
-/
