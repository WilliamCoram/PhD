...
-/
import PhD.Main.BirkovichWP.RingTheory.MvPowerSeries.Restricted.GaussNorm
...
`PhD/Main/BirkovichWP/RingTheory/PowerSeries/Restricted/WeierstrassDivision.lean`).

`PhD/Main/ForMathlib/` carries only the order-free
