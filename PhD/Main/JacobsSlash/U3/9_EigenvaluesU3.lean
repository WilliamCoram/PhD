...
-/
import PhD.Main.JacobsSlash.U3.«8_HeckeSlopes»
import PhD.Main.JacobsSlash.U3.«2_PadicEmbedding»
import PhD.Main.JacobsSlash.«5_EigenSlopes»
import PhD.Main.JacobsSlash.«5_Instance»
import PhD.Main.JacobsSlash.U3.«7_DiamondHecke»

/-!
# The eigenvalues of `U₃` have valuation `j + ½`

**The culmination of the development** — Riesz theory (`PhD.Main.TateFredholm.«09_Riesz»`), the
Newton-polygon zero theory (`PhD.Main.NewtonPolygons`), and the fork's identification of the
genuine Hecke operator (`PhD.Main.JacobsSlash`), composed:
