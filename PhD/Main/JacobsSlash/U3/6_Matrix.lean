...
-/
import PhD.Main.JacobsSlash.«4_DiamondW»
import PhD.Main.JacobsSlash.CN1.«4_Dictionary»
import PhD.Main.JacobsSlash.U3.«5_Factorisations»
import PhD.Main.JacobsSlash.U3.«5_KappaWeight»
...
`JacobsSlash.h01 … h21` in `PhD.Main.JacobsSlash.«2_U3Data»`.
...
(`PhD.Main.JacobsSlash.«2_U3Data»`, misprint corrected).  The diagonal is `0`
[Jacobs p. 28]. -/
...
transcribed `ε`-operator of `PhD.Main.JacobsSlash.«4_DiamondW»`, with no coboundary
scalar. -/
...
`hClassNumberOne`, proven in `PhD/Main/JacobsSlash/CN1/` (sorry-free, standard axioms). -/
