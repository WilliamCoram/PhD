...
Two layers, both consumed by `PhD.Main.JacobsSlash.U3.HeckeSlopes` (the endgame board
...
* The Fredholm-determinant half moved to the general layer on 2026-08-20 (forms-riesz
  ...
  (`PhD/Main/TateFredholm/08_BaseChange.lean`), and `MvPowerSeries.map_inv₀`,
  `TateFredholm.map_linSeries`, `TateFredholm.map_quadSeries` live next to their
  definitions (`PhD/Main/ForMathlib/RingTheory/MvPowerSeries/Inverse.lean`,
