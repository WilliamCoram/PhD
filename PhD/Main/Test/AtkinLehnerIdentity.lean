...
**This is a `PhD/Main/Test/` scratch file.**  It is not imported by `PhD.lean` and is not part of any
...
`PhD/Main/LWX/05_AtkinLehner.lean` proves [LWX, Prop 3.22] *granted* the operator identity
...
`PhD/Main/LWX/05_AtkinLehner.lean`.
-/
