...
This file is deliberately **independent** of `PhD.Main.Test.CompactOperators` (the parallel
...
## Differences from the Buzzard blueprint (`PhD.Main.Test.CompactOperators`)
...
is Noetherian or a field.  The merged development (`PhD.Main.TateFredholm.«04_Matrix»`) states it
