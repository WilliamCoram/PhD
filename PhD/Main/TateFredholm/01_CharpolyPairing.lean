...
This is the linear-algebra half of the Atkin–Lehner reduction (`PhD/Main/LWX/05_AtkinLehner.lean`): with
...
`LWX.norm_roots_charpoly_atkinLehner` in `PhD/Main/LWX/05_AtkinLehner.lean`; it is kept there so that this
