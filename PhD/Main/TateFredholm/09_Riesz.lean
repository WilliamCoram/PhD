...
import PhD.Main.ForMathlib.RingTheory.PowerSeries.Restricted.MulWeierstrassDivision
...
`PhD.Main.ForMathlib` at a radius `c > ‖a‖` (where `1 - a⁻¹X` is `IsMulDistinguished c 1`),
