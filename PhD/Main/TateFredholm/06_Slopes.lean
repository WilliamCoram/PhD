...
Everything here was generalised out of `PhD/Main/JacobsSlash/«1_SlopeTheorem».lean`, whose statements
...
valuation-sequence input the Newton-polygon machinery consumes (`PhD.Main.NewtonPolygons`). -/
