...
generalisation lives in `PhD/Main/QMF/Weight/` (`WeightSeries`, `kappaSlash`); this
...
analytic κ, [Jacobs, Def 1.27]) see `PhD/Main/QMF/Weight/` and the module docstring above.
