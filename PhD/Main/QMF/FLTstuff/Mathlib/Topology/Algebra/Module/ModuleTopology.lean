...
import PhD.Main.QMF.FLTstuff.Deformations.ContinuousRepresentation.IsTopologicalModule
...
declarations needed by `PhD.Main.QMF.FLTstuff.Mathlib.Topology.Algebra.RestrictedProduct.Module`
...
file for `PhD.Main.QMF.FLTstuff.DedekindDomain.Completion.BaseChange`.

-- PORT (T016d-2b extension): `IsModuleTopology.continuousAlgEquivOfAlgEquiv` appended
(needed by `PhD.Main.QMF.FLTstuff.DedekindDomain.FiniteAdeleRing.BaseChange`).
...
`PhD.Main.QMF.FLTstuff.NumberField.{Completion.Infinite, InfiniteAdeleRing, AdeleRing}`.
...
`PhD.Main.QMF.FLTstuff.HaarMeasure.HaarChar.Ring`.
...
`PhD.Main.QMF.FLTstuff.DivisionAlgebra.Finiteness`.
-/
...
-- (`Module.Basis.equivFunHomeo`), needed by `PhD.Main.QMF.FLTstuff.HaarMeasure.HaarChar.Ring`.
