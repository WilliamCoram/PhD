...
import PhD.Main.QMF.FLTstuff.Mathlib.Topology.Algebra.RestrictedProduct.Algebra
...
PORT (T016d-2b) of `FLT.Mathlib.RingTheory.DedekindDomain.FiniteAdeleRing` (221 l.,
load-bearing for `PhD.Main.QMF.FLTstuff.DedekindDomain.FiniteAdeleRing.{TensorProduct,BaseChange}`).
-/
