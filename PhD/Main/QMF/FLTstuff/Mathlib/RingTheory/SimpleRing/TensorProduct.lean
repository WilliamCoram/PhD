...
PORT (T016f-2a) of `FLT.Mathlib.RingTheory.SimpleRing.TensorProduct`, pulled in as an extra
dependency of `PhD.Main.QMF.FLTstuff.Mathlib.LinearAlgebra.Determinant`: mathlib (as of this bump)
still has no `IsSimpleRing (A ⊗[K] B)` instance, so none of this file could be substituted away.
-/
