...
-/
import PhD.Main.QMF.FLTstuff.HaarMeasure.MeasurableSpacePadics
import PhD.Main.QMF.FLTstuff.HaarMeasure.HaarChar.Ring
import PhD.Main.QMF.FLTstuff.Mathlib.MeasureTheory.Group.Action
import PhD.Main.QMF.FLTstuff.Mathlib.NumberTheory.Padics.PadicIntegers
...
`PhD.Main.QMF.FLTstuff.HaarMeasure.MeasurableSpacePadics`; it must never be co-imported with
`PhD.Main.QMF.FLTstuff.Mathlib.MeasureTheory.Constructions.BorelSpace.Padic`, which declares a
competing one.
-/
