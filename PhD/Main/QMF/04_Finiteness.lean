...
import PhD.Main.QMF.FLTstuff.DivisionAlgebra.Finiteness
...
in `PhD/Main/QMF/FLTstuff/DivisionAlgebra/Finiteness.lean` (ported from FLT, by Buzzard–Coram) as
...
`PhD/Main/QMF/FLTstuff/DivisionAlgebra/Finiteness.lean`) transported along
