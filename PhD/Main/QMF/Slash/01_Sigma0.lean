...
-/
import PhD.Main.QMF.«00_Sigma0»
import Mathlib.LinearAlgebra.Matrix.Adjugate

/-!
# The right-handed monoid `Σ₀'(γ)` and the adjugate dictionary

`Sigma0 K γ hγ` (see `PhD/Main/QMF/00_Sigma0.lean`, incl. the design note on the left/right
...
This is the foundation of the right-slash dialect (`PhD/Main/QMF/Slash/02_Basic.lean`): statements
