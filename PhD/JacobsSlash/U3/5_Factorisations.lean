...
-/
import PhD.JacobsSlash.U3.«3_ClassSet»
import PhD.JacobsSlash.U3.«3_EtaDecomposition»
...
The tables were computed by `PhD/JacobsSlash/U3/certificate_search.py` (2026-08-06,
...
certificate search (`PhD/JacobsSlash/U3/certificate_search.py`, section `LEAN
...
`PhD.JacobsSlash.«2_U3Data»` ON THE NOSE.  In the thesis orientation the left library's
